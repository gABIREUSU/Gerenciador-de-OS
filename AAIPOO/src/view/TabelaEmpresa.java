...
public class TabelaEmpresa extends JFrame {
    ...
    public TabelaEmpresa() {
        ...
        JLabel lblTitulo = new JLabel("Lista de Empresas Cadastradas");
        lblTitulo.setBounds(209, 11, 150, 14);
    ...
    public void atualizarDados(JTable tabela) {
    	...
    	String tel;
		if (linha != -1) {
			cod = Integer.parseInt((String) tabela.getValueAt(linha, 0));
