...
public class TelaConsulta extends JFrame {
	...
	private final Map<String, String[]> filtrosPorTabela = Map.of("Empresas", new String[] { "Todos", "Nome", "CNPJ" },
			"Equipamento", new String[] { "Todos", "NomeEquip", "NomeEmpresa" }, "OS",
			new String[] { "Todos", "Data", "NomeEquip", "NomeEmpresa" });
	...
	private void buscarDados() {
		...
		List<Object[]> dados = controller.buscarDados(tabelaSelecionada, campoFiltro, valorFiltro);
		String[] colunas = controller.getColunas(tabelaSelecionada);
