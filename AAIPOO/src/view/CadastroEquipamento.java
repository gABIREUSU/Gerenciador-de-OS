...
public class CadastroEquipamento extends JFrame {
    ...
    public CadastroEquipamento() {
        ...
        titulo.setBounds(147, 11, 273, 30);
        painel.add(titulo);

        txtNome = new DJTextField("    Nome do Equipamento");
        txtNome.setBounds(147, 123, 240, 30);
        painel.add(txtNome);
        addFocus(txtNome);

        JLabel lblEmpresa = new JLabel("Empresa:");
        lblEmpresa.setForeground(Color.WHITE);
        lblEmpresa.setBounds(147, 52, 240, 20);
        painel.add(lblEmpresa);

        comboEmpresas = new JComboBox<>();
        comboEmpresas.setBounds(147, 72, 240, 30);
        painel.add(comboEmpresas);
        carregarEmpresas();

        RoundButton btnLimpar = new RoundButton("Limpar");
        btnLimpar.setBounds(100, 185, 86, 30);
        ...
        btnSalvar.setBounds(352, 185, 100, 30);
    ...
    private void salvarEquipamento() {
        ...
        if (nome.isEmpty() || nomeEmpresa == null || nomeEmpresa.isEmpty()) {
